...
class GameRunner:
    ...
    def test_runner(self):
        ...
        for step in range(5000):
            ...
            state, reward, done, info = env.step(env.action_space.sample()) #state, reward, done, info = env.step(2)#
            env.render()
    ...
    def eval_single_genome(self, worker_num, genome_list):
        ...
        for state in self.level_states:
            ...
            env = JoypadSpace(env, SIMPLE_MOVEMENT) # RIGHT_ONLY , SIMPLE_MOVEMENT, COMPLEX_MOVEMENT --SIMPLE_MOVEMENT is recommended
            env.action_space.sample()
            ...
            for genome_id, genome in genome_list:
                ...
                #print('fitness_begin: {}'.format(fitness_current))
                ...
                while not done:
                    ...
                    # TODO: Need to double check the convolution - this is likely causing the errors
                    # env.step probably works differently and returns a differently shaped obs
                    '''
                        (240, 256, 3)
                        5
                        SUCCESS
                    ...
                    # TODO: add this back?
                    nn_output = SIMPLE_MOVEMENT[nn_output]
                    
                    print("bbb")
                    print(nn_output)

                    # TODO: convert nn_output ['right', 'b'], etc to an integer here

                    #nn_output = env.action_space.sample()
                    #nn_output = env.action_space.sample() #- 1
                    #print("ccc")
                    #print(nn_output)
                    ...
                    #print('fitness: {}'.format(fitness_current))
